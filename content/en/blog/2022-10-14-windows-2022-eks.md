...
Most of you will know, that every packer build has a [builder](#the-builder), which is sort of the main loop, a [communicator](#communicator) and one or multiple [provisioners](#provisioners). So I have set up sections for each one of them.
...
Now it is time to do things to the instance we are running.

These are the things I'm doing. Your mileage might vary, but points 1, 3, part of 5, and 6 are essential
...
The amount of pain was ridiculous (and also it involves some security constraints in my company).
